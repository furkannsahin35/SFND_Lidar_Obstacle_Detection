...
void render2DTree(Node* node, pcl::visualization::PCLVisualizer::Ptr& viewer, Box window, int& iteration, uint8_t depth = 0)
{
...
int main()
{
	...
	//std::vector<int> nearby = tree->search({6.0,6.0},10.0);
	...
	//
	std::vector<std::vector<int>> clusters = euclideanCluster(points, tree, 9.0);
	//
